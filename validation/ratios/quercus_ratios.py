...
def validate_ratios(original_model, diel_model, original_multitissue_model, diel_multitissue_model):
    ...
    diel_model.reactions.get_by_id("Biomass_Total").lower_bound = 0.14
    diel_model.reactions.get_by_id("Biomass_Total").upper_bound = 0.14
    ...
    diel_multitissue_model.reactions.get_by_id("Biomass_Total").lower_bound = 0.11
    diel_multitissue_model.reactions.get_by_id("Biomass_Total").upper_bound = 0.11
    ...
    tabel.index = ["Quercus", "Quercus Multi Tissue", "Day Quercus", "Night Quercus", "Day Multi Quercus", "Night Multi Quercus"]
