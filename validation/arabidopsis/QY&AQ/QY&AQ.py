...
if __name__ == '__main__':
    ...
    fba_sol_non_diel, fba_sol_diel_model = QY_AQ(original_model, diel_model)
    ...
    data_quantum_assimilation = {
        ...
        'Assimilation Quotient': [fba_sol_non_diel["R00024_p"] / fba_sol_non_diel["REner01_p"],
                            fba_sol_diel_model["R00024_p_Day"] / - fba_sol_diel_model["REner01_p_Day"]]}

    tabel = pd.DataFrame(data_quantum_assimilation)

    tabel.index = ["Original AraGEM Model", "Created Diel AraGEM"]

    tabel.to_csv('QY&AQ_AraGEM.csv', sep=',')
